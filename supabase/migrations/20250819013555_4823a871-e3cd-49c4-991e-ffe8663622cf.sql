...
-- 3. Secure order notifications - only system should create them
...
-- 4. Secure payment splits - only system should create them  
...
-- 5. Secure email performance logs - only service role should insert
